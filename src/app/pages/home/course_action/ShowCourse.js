                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="form-group row">
                                    <label className="col-xl-3 col-lg-3 col-form-label">Tên học phần</label>
                                    <p className="col-md-3 col-lg-3 col-form-label" name="name">{data.name}</p>
                                </div>

                                <div className="form-group row">
                                    <label className="col-xl-3 col-lg-3 col-form-label">Số lượng lớp học phần</label>
                                    <p className="col-md-3 col-lg-3 col-form-label"><Link to={"/course_classes/" + data.id}>{data.total_course_classes}</Link></p>
                                </div>
