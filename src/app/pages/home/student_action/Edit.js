...
import { getStudent, editStudent } from '../../../crud/students.crud'
...
export default function EditPage(props) {
    ...
    const [currentData, setCurrentData] = useState({university_class: []});
                    ...
                    <Container maxWidth="md">
                        <Formik
                            ...
                            initialValues={{
                                ...
                                university_class_id: currentData.university_class.id,
                            }}
                            onSubmit={(values, { setStatus, setSubmitting }) => {
                                var data = values;
                                editStudent(student_id, data).then((data) => {
