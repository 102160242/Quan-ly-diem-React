                    ...
                    <Container maxWidth="sm">
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <div className="form-group row">
                                    <label className="col-md-3 col-form-label">Lớp sinh hoạt </label>
                                    <p className="col-md-3 col-form-label" name="university_class"><Link to={"/university-classes/" + university_class_id}>{data.university_class && data.university_class.name}</Link></p>
                                </div>

                                <div className="form-group row">
                                    <label className="col-md-3 col-form-label">Khoa </label>
                                    <p className="col-md-3 col-form-label" name="faculty">{data.university_class && data.university_class.faculty}</p>
                                </div>
