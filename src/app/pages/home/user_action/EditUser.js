                                        ...
                                        <div className="kt-form__actions">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-9 col-xl-6">
                                                    ...
                                                    <button disabled={isSubmitting} className="btn btn-clean btn-bold"  >Thoát</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="kt-section kt-section--first">
                                                <div className="kt-section__body">
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-lg-9 col-xl-6">
                                                            <h3 className="kt-section__title kt-section__title-sm"><strong>Thay đổi hoặc khôi phục lại mật khẩu:</strong></h3>
                                                        </div>
                                                    </div>
                                                    <div className="form-group row">
